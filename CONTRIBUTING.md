# Contributing to `methyvim` development
...
3.  __Use `methyvim` coding style__. To do so, please follow the
    [official ggplot2 style](http://adv-r.had.co.nz/Style.html). Maintaining
    a consistent style across the whole code base makes it much easier to
    jump into the code. If you're modifying existing `methyvim` code that
