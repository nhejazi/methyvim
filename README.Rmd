...
For details on how to best use `methyvim` to perform data-adaptive estimation
and obtain nonparametric inference in the context of differential methylation
analyses, please consult the most recent [package vignette](http://bioconductor.org/packages/release/bioc/vignettes/methyvim/inst/doc/using_methyvim.html)
