...
in the `vim` `slot` of the `methytmle` object) simply by invoking the S4 `show`
method of the resultant object:
...
invoking the S4 `show` method of the resultant object:
