...
[@vdl2011targeted, @vdl2018targeted]. As counterfactuals are contrary-to-fact --
...
that may be reliably estimated from observed data [@pearl2009causality]. We
describe an algorithm that incorporates the estimation of VIMs using _targeted
minimum loss-based estimation_ (__TMLE__) [@vdl2006targeted], deferring detailed
...
in [@tuglus2008targeted]. In the presnet work, we focus on a software package,
