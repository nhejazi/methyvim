---
title: '`methyvim`: Targeted and Model-free Analysis of Differential Methylation
in R'
author:
  - name: Nima S. Hejazi
...
We refer the reader to the package vignette, "`methyvim`: Targeted Learning for
Differential Methylation Analysis," included in any distribution of the software
