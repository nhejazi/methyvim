...
manner using the Super Learner algorithm for ensemble modeling [@vdl2007super,
@wolpert1992stacked, @breiman1996stacked, @gruber2009targeted,
@vdl2011targeted].
...
p-values) for the subsequent analysis steps in the `methyvim` pipeline. Details
...
the [`tmle`](https://CRAN.R-project.org/package=tmle) R package
...
score [@rosenbaum1983central], often denoted by $g(A \mid W)$; (2) an estimator
...
[@wolpert1992stacked, @breiman1996stacked, @vdl2007super], which ensures
...
@vdl2003unified]. After constructing such estimates, an iterative procedure
