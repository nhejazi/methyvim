#' Differential Methylation with the Risk Ratio
#'
#' Computes the Targeted Minimum Loss-Based Estimate of the Risk Ratio (RR),
#' treating DNA methylation as an outcome (Y) and the indicated variable of
#' interest (which ought to be binarized) as a treatment/exposure (A), using the
#' neighbors of a given CpG site as the adjustment set (W).
#'
